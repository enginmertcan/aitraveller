...
import { colors, borderRadius, shadows } from '../components/ThemeRegistry/theme';
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 8 }}>
      <Box sx={{
        ...
        <Box>
          ...
          >
            Diğer kullanıcıların önerdiği seyahat planlarını keşfedin. Bu planlar, kullanıcıların memnun kaldıkları ve başkalarına tavsiye ettikleri seyahatlerdir.
          </Typography>
        </Box>
      </Box>
      ...
      {loading ? (
        ...
        <NoTripsContainer>
          ...
          >
            Kullanıcılar seyahat planlarını önerdikçe burada görünecekler. Siz de kendi seyahat planınızı oluşturabilir ve başkalarıyla paylaşabilirsiniz.
          </Typography>
